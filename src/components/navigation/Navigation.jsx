      ...
      <ul className={css.ul}>
        ...
        <li className={css.ul__li}>
          <NavLink to="/" className={css.ul__li__navLink}>
            <button type="button" className={css.ul__li__navLink__btn}>Customers</button>
          </NavLink>
        </li>
        <li className={css.ul__li}>
          <NavLink to="/other" className={css.ul__li__navLink}>
            <button type="button" className={css.ul__li__navLink__btn}>Income</button>
          </NavLink>
        </li>
        <li className={css.ul__li}>
          <NavLink to="/other" className={css.ul__li__navLink}>
        ...
        <li>
          <NavLink to="/other" className={css.ul__li__navLink}>
            <button type="button" className={css.ul__li__navLink__btn}>Help</button>
          </NavLink>
        </li>      
      </ul>
    </nav>
